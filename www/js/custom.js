...
// styles for the questionScreen starts here
s.style.width = '98.5%';
s.style.height = '20px';
s.style.fontSize = '20px';
s.style.padding = '10px';
s.style.marginTop = '-10px';
// styles for the questionScreen ends here

// styles for the answerScreen starts here
answerScreen.style.width = '98.5%';
answerScreen.style.height = '20px';
answerScreen.style.fontSize = '20px';
answerScreen.style.padding = '10px';
answerScreen.style.marginTop = '-40px';
answerScreen.style.textAlign = 'right';
// styles for the answerScreen ends here
...
for (i = 0; i <= 16; i++) {
    ...
    // bt.style.transition = '0.5s all ease-in';
...
//             s.innerHTML+=this.value;
//        }
        // bt.style.boxShadow = '0px 0px opx black';
        // bt.style.transition = '0.9s all ease-in';
       
        if(this.value == 'del'){
            var oldval = s.innerHTML;
            var newval = oldval.substring(0,  oldval.length-1);
            s.innerHTML = newval;
            answerScreen.innerHTML = eval(s.innerHTML);
            if (s.innerHTML == '') {
